...
export const metadata = {
  title:
    "How to Choose the Right Waterproofing Contractor: A Complete Homeowner’s Guide",
  description:
    "Learn how to choose the right waterproofing contractor with expert tips, red flags, costs, and local insights to protect your property.",
  keywords:
    "waterproofing contractor, waterproofing services, roof waterproofing, basement waterproofing, waterproofing company NYC, waterproofing solutions, residential waterproofing, commercial waterproofing, waterproofing experts, leak prevention services",
  openGraph: {
    title:
      "How to Choose the Right Waterproofing Contractor: A Complete Homeowner’s Guide",
    description:
      "Learn how to choose the right waterproofing contractor with expert tips, red flags, costs, and local insights to protect your property.",
    url: "https://www.sasroofingwaterproofing.com/blog/how-to-choose-right-waterproofing-contractor",
    images: [
      {
