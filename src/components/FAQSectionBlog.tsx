          ...
          return (
            ...
            >
              <button
                ...
                className="w-full flex justify-between items-center p-4 text-left focus:outline-none focus:ring-2 focus:ring-[#003269]"
              ...
              >
                <span
                  ...
                  className="text-lg font-medium text-[#003269]"
                >
                  {faq.question}
                </span>
                <ChevronDownIcon
              ...
              <AnimatePresence initial={false}>
                {isOpen && (
                  <motion.div
                    ...
                    className="px-4 py-5 text-black overflow-hidden"
                  >
                    <p>{faq.answer}</p>
                  </motion.div>
                )}
