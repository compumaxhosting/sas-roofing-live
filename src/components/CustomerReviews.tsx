...
export default function CustomerReviews() {
  return (
    <section
      ...
      role="region" // Assign role="region" to define a perceivable section
      aria-labelledby="customer-reviews-heading" // Link the region to its heading
    >
      <div className="text-center mb-6">
        <h2
          id="customer-reviews-heading" // Unique ID for aria-labelledby
      ...
      <div className="flex flex-wrap justify-center gap-6 sm:gap-8">
        {reviewLogos.map(({ alt, src, href }, index) => (
          <motion.a
            ...
            aria-label={`Visit our reviews on ${alt} (opens in a new tab)`} // Explicitly mention "opens in a new tab" for accessibility
          ...
          >
            <Image
              src={src}
              alt={alt} // `alt` attribute is correctly set
              width={72}
              height={72}
              loading="lazy"
