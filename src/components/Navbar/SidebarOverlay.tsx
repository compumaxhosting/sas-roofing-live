...
export default function SidebarOverlay({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    ...
    if (currentAside) {
      ...
      currentAside.addEventListener("keydown", handleTabKey); // Use currentAside here
      ...
      >
        ...
        <section aria-labelledby="free-quote-heading" className="mb-6">
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
            ...
            {/* Removed the extra div wrapper to ensure full width as discussed previously */}
